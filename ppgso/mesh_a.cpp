...
ppgso::Mesh_a::Mesh_a(const std::string &obj_file) {
...
void ppgso::Mesh_a::processNode(aiNode *node, const aiScene *pScene) {
...
void ppgso::Mesh_a::processMesh(aiMesh *mesh) {
    gl_buffer buffer;
